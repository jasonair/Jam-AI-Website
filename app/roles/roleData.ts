...
export const roleData: Category[] = [
  {
    ...
    roles: [
      ...
      { name: 'Business Analyst', description: 'Analyzes business processes, gathers requirements, and bridges business and technical teams.', icon: BarChart3, color: 'blue' },
      { name: 'Strategy Consultant', description: 'Advises organizations on strategy, growth, and competitive positioning.', icon: Lightbulb, color: 'purple' },
  ...
  },
  {
    ...
    roles: [
      ...
      { name: 'AI/ML Engineer', description: 'Develops machine learning models, AI systems, and deploys ML solutions at scale.', icon: Brain, color: 'cyan' },
      ...
      { name: 'Full-Stack Engineer', description: 'Develops complete applications across frontend, backend, and databases.', icon: Layers, color: 'teal' },
      { name: 'Data Scientist', description: 'Analyzes data, builds models, and extracts insights using statistics and ML.', icon: LineChart, color: 'cyan' },
      { name: 'DevOps Engineer', description: 'Builds CI/CD pipelines, manages infrastructure, and ensures reliable deployments.', icon: Server, color: 'red' },
      { name: 'LLM Engineer', description: 'Builds and deploys LLM applications, integrates AI models, and optimizes inference.', icon: Brain, color: 'blue' },
      ...
      { name: 'Computer Vision Engineer', description: 'Develops image and video AI systems for object detection, recognition, and visual understanding.', icon: Eye, color: 'cyan' },
      { name: 'NLP Engineer', description: 'Builds natural language processing systems for text understanding, generation, and analysis.', icon: MessageSquare, color: 'orange' },
      { name: 'AI Research Scientist', description: 'Conducts AI research, publishes papers, and advances the state of the art in machine learning.', icon: FlaskConical, color: 'indigo' },
      { name: 'ML Architect', description: 'Designs ML system architectures, selects technologies, and guides ML infrastructure strategy.', icon: Building, color: 'yellow' },
    ]
  },
  {
    name: 'Finance',
  ...
  },
  {
    name: 'Creative',
    roles: [
      { name: 'Content Writer', description: 'Creates engaging content for blogs, marketing, documentation, and social media.', icon: FileText, color: 'purple' },
      { name: 'Copywriter', description: 'Writes persuasive copy for ads, websites, emails, and marketing materials that drives action.', icon: PenTool, color: 'red' },
