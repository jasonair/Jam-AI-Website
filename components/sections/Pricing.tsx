        ...
        <Container size="xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {plans.map((plan, index) => (
              <div
                key={index}
                className={`relative rounded-2xl p-8 border-2 transition-all duration-300 ${plan.highlighted
          ...
          <div className="mt-12 text-center space-y-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-500">
              Compatible with macOS (Apple Silicon). Intel processors are not supported.
            </p>
          </div>
        </Container>
      </Section>
